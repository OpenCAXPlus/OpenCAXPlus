...
IF NOT DEFINED CMAKEBINDIR SET CMAKEBINDIR=C:\\PROGRAM FILES (X86)\\MICROSOFT VISUAL STUDIO\\2019\\COMMUNITY\\COMMON7\\IDE\\COMMONEXTENSIONS\\MICROSOFT\\CMAKE\\CMake\\bin
SET CMAKE="%CMAKEBINDIR%\\cmake.exe"
SET CTEST="%CMAKEBINDIR%\\ctest.exe"
