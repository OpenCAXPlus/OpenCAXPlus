...
public:
    ...
    int    size() { return slices_num.size(); }
    int    SlicesNum(int n) { return slices_num[n]; }
    double SliceHeight(int n) { return height[n]; }
    ...
    double x_min() { return convex_hull[0]; }
    double x_max() { return convex_hull[1]; }
    double y_min() { return convex_hull[2]; }
    double y_max() { return convex_hull[3]; }
    double z_min() { return convex_hull[4]; }
    double z_max() { return convex_hull[5]; }
};
