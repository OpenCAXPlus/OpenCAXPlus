...
void LS::Newton()
{
    ...
    for (int i = 0; i < 10000; i++) {
        for (int j = 0; j < pc_num; j++) {
            ...
            a11 += (d_x(j, x_0, y_0) / d(j, x_0, y_0) +
                    (d(j, x_0, y_0) - radius) * d_xx(j, x_0, y_0)) *
                       (x_0 - pc[2 * j]) +
                   (d(j, x_0, y_0) - radius) / d(j, x_0, y_0);
            a22 += (d_y(j, x_0, y_0) / d(j, x_0, y_0) +
                    (d(j, x_0, y_0) - radius) * d_yy(j, x_0, y_0)) *
                       (y_0 - pc[2 * j + 1]) +
                   (d(j, x_0, y_0) - radius) / d(j, x_0, y_0);
            a12 += (d_y(j, x_0, y_0) / d(j, x_0, y_0) +
                    (d(j, x_0, y_0) - radius) * d_yy(j, x_0, y_0)) *
                   (x_0 - pc[2 * j]);
            a21 += (d_x(j, x_0, y_0) / d(j, x_0, y_0) +
                    (d(j, x_0, y_0) - radius) * d_xx(j, x_0, y_0)) *
                   (y_0 - pc[2 * j + 1]);
        }
