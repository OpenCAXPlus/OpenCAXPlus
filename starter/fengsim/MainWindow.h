...
public slots:
    ...
    // *******************************************************
    // general
    void TextOutput(QString str) { vtk_widget->TextOutput(str); }
