...
{
    TopoDS_Shape* S1 = new TopoDS_Shape(BRepPrimAPI_MakeCylinder(gp_Ax2(gp_Pnt(-140*transport_level/2,0,0),gp_Dir(1,0,0)),200,140*transport_level).Shape());
    TopoDS_Shape* S2 = new TopoDS_Shape(BRepPrimAPI_MakeCylinder(gp_Ax2(gp_Pnt(-140*transport_level/2,0,0),gp_Dir(1,0,0)),260.4,140*transport_level).Shape());
...
void MainWindow::TransportMakeDetectors()
{
    for (double j=0; j<transport_level; j++) {
        TopoDS_Shape* S = new TopoDS_Shape(BRepPrimAPI_MakeCylinder(gp_Ax2(gp_Pnt(70+j*140-140*transport_level/2,0,(200+260.4)/2.0-50.8/2.0),gp_Dir(0,0,1)),40,50.8).Shape());
        Cylinder* A = new Cylinder(S);
        transport_parts->Add(A);
...
void MainWindow::TransportMCRun()
{
    ...
    if (proc->waitForFinished(-1)) {
        ...
        out.close();
        is.close();
        vtk_widget->TransportImportVTKFile("/home/jiping/fengsim-install/output2.vtk",9);
