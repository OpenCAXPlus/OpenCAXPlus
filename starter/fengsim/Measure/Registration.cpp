...
//         pcl::PointCloud<pcl::PointXYZ>::Ptr &output )
{
    ...
    // Instead you need to use the in-built functions provided by PCL to turn off the
    // console printing. pcl::console::setVerbosityLevel(pcl::console::L_ALWAYS);
...
void Registration::box_fit()
{
    ...
    std::cout << x1[0] << " " << x1[1] << " " << x1[2] << " " << x1[3] << " " << x1[4]
              << " " << x1[5] << std::endl;
    std::cout << x2[0] << " " << x2[1] << " " << x2[2] << " " << x2[3] << " " << x2[4]
              << " " << x2[5] << std::endl;
}
