macro(OCP_Toolkit_External_Download)
  set(options)
  set(oneValueArgs SOFTWARE VERSION SUBFOLDER URL)
  ...
  if(NOT EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/${tarname}.tar.xz)
    message(STATUS ${OCPExternal_URL} ${tarname}.tar.xz)
    file(DOWNLOAD ${OCPExternal_URL}
         ${CMAKE_CURRENT_SOURCE_DIR}/${tarname}.tar.xz)
  endif()
